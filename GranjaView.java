...
/**
 * Use los comentarios para explicar el objetivo de este programa GranjaView .
 *
 * @author Ponga aqui su nombre y correo
 * @version Ponga aquí la versión o fecha
 */
public class GranjaView extends Application{
    ...
    public void start(Stage stage) throws Exception{
        ...
        String fxmlDocPath = "GranjaView.fxml";
